...
const KernelOutput = ({ outputType, output }: KernelOutputProps) => {
  const typedOutput = useTypewriter(output, 12, 10);
  ...
  return (
    <div
      ref={wrapperRef}
      className="w-full flex flex-col gap-2 px-2 mt-5 pb-10"
    >
      ...
      <div
        ref={containerRef}
        className="relative w-full max-h-160 overflow-y-auto kernel-scrollbar bg-black/60 backdrop-blur-md rounded-xl border border-emerald-500/90 px-5 py-8 text-emerald-50 text-md leading-relaxed whitespace-normal"
      >
        <button
